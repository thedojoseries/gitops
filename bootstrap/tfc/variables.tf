...
variable "terraform_version" {
  description = "The version of Terraform to use for this workspace. Default is latest."
  default     = null
}
...
variable "slack_notifications" {
  description = "Map of `tfe_notification_configurations` to define in the workspace. Leave blank for none."
  default     = {}
